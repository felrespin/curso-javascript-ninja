(function() {
    ...
    */
	var arrSudeste = ['São Paulo', 'Rio', 'Minas Gerais', 'Espírito Santo'];
	var arrSul = ['Rio Grande do Sul', 'Paraná', 'Santa Catarina'];
    ...
    */
	...
	console.log(
		every ? 'Sim. Todos os estados tem mais de sete letras.' : 'Nem todos os estados tem mais de sete letras.'
	);
	/*
